...
namespace eBPF_verifier
{
	public class Example3
	{
		...
		public void Execute()
		{
            ...
            var e1_5 = new AssignmentEdge(p1, p1_5, x, new ArithmeticExpresion(x, new Literal(1), ArithmeticOperation.Add));
            var e2 = new BranchEdge(p1_5, p2, new Condition(x, ">", new Literal(0)));
            var e3 = new AssignmentEdge(p2, p3, y, new ArithmeticExpresion(new Literal(2), new Literal(0), ArithmeticOperation.Add));
            var e4 = new BranchEdge(p1_5, p4, new Condition(x, "<=", new Literal(0)));
